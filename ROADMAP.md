# 🗂️ ROADMAP — FewShot-Polyp-Detection

**Project:** Few-Shot Polyp Detection in Colonoscopy
**Team:** Percepta
**Course:** Computer Vision (Fall 2025)
**Instructor:** Dr. I. Atadjanov
...
### Week 2 (Oct 21–27)
- [ ] Complete literature review on few-shot object detection and polyp detection.
- [ ] Download Kvasir-SEG and CVC-ClinicDB datasets and create 5-shot splits.

### Week 3 (Oct 28–Nov 3)
- [ ] Set up YOLOv8 and Mask R-CNN training scripts.
- [ ] Run and log 5-shot training experiments for baseline models.

### Week 4 (Nov 4–10)
- [ ] Implement the chosen few-shot architecture (e.g., prompt-tuned ViT detector).
- [ ] Begin training the proposed model on the 5-shot data.

### Week 5 (Nov 11–17)
- [ ] Run final evaluation on test set for all models.
- [ ] Generate comparative result tables (mAP, F1) and create visual explanations.

### Week 6 (Nov 18–24)
- [ ] Analyze why the proposed model succeeded/failed compared to baselines.
- [ ] Write the core sections of the final report (Method, Experiments, Results).

### Week 7 (Nov 25–Dec 1)
- [ ] Finalize the project report (PDF).
- [ ] Prepare and practice the final presentation.

### Week 8 (Dec 2–8)
- [ ] Upload final code, model weights, and report to the repository.
...
- ✅ **Final Report & Code:** Comprehensive PDF report and a fully functional code repository.
- ✅ **Trained Models:** Weights for the baseline and proposed few-shot models.
- ✅ **Presentation Slides:** Final project presentation.
- ✅ **Weekly Logs:** Updated progress in this ROADMAP.md file.
